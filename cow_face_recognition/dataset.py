...
def get_dataloader(
    ...
    rec = os.path.join(root_dir, 'datasets/original/train.rec')
    idx = os.path.join(root_dir, 'datasets/original/train.idx')
    train_set = None
...
class MXFaceDataset(Dataset):
    def __init__(self, root_dir, local_rank):
        ...
        self.local_rank = local_rank
        path_imgrec = os.path.join(root_dir, 'datasets/original/train.rec')
        path_imgidx = os.path.join(root_dir, 'datasets/original/train.idx')
